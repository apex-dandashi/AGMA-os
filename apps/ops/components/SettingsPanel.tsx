  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-gray-medium">
        النسبة الأولى هي المطبّقة الآن في كل جولة توزيع، والثانية هي الهدف
        الذي نتدرج إليه بخطوة ١–٢٪ كل ثلاثة أشهر. مجموع النسب المطبّقة يجب أن
        يساوي ١٠٠٪ تماماً. (قرار شركاء)
      </p>
      <div className="space-y-1.5">
        {data.map((r) => (
