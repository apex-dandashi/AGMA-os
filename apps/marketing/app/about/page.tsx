        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-medium text-base sm:text-lg lg:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-medium px-6">
              تأسست AGMA لتقود تطوراً جديداً في التسويق: الذكاء الاصطناعي بنية تشغيلية كاملة تصنع السرعة والدقة والنمو القابل للقياس.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-gray-medium text-lg leading-relaxed font-medium">
                <p>
                  وُلدت AGMA حين بدأ الذكاء الاصطناعي يعيد تعريف رحلة العميل من أول بحث إلى الولاء.
                </p>
                <p>
                  أغلب الوكالات تضيف أدوات الذكاء الاصطناعي زينةً على عمليات قديمة. نحن بنينا وكالة Native-AI من الصفر.
                </p>
                <p>
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-gray-medium text-xl leading-relaxed font-medium">
              سعوديو المنشأ. نفهم الحراك الثقافي والاقتصادي في المملكة من الداخل، ونعرف سرعة التطور التي تفرضها رؤية 2030، ونتحدث لغة السوق السعودي والخليجي كواقع نعيشه.
            </p>
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="order-1 lg:order-2 space-y-8">
                ...
                <div className="space-y-6 text-gray-medium text-lg leading-relaxed font-medium">
                  <p>
                    الذكاء الاصطناعي عمودنا الفقري لا أداة جانبية. كل رحلة عميل وكل استراتيجية محتوى وكل حملة تمر عبر منظومة أتمتة ذكية.
                  </p>
                  <p>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-medium text-lg leading-relaxed font-medium">
                  وُجدت AGMA لتغلق الفجوة بين التقنية المعقدة والأهداف التجارية. شريك واحد يجمع استراتيجية الذكاء الاصطناعي والإبداع وتسويق الأداء والمنتجات الرقمية تحت سقف واحد.
                </p>
