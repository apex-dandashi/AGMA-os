...
export default function PrivacyPageClient() {
  ...
  return (
    <main data-silk-mood="silence" className="min-h-screen relative overflow-hidden">
      <Header />
      ...
      <section className="py-24 px-6 relative">
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-16">
            ...
            {/* Complaints, feedback & careers data (L10 — added with the public layer) */}
            <article className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                <ShieldCheck className="text-pulse-orange" size={24} />
                <h2 className="text-2xl lg:text-3xl font-bold text-snow">6.1 بيانات الشكاوى والتقييم والتوظيف</h2>
              </div>
              <div className="space-y-4 text-gray-medium text-lg leading-relaxed font-medium">
                <p>
                  <strong className="text-snow">الشكاوى والملاحظات:</strong>{' '}
                  عند تقديم شكوى عبر الموقع نجمع بيانات التواصل ووصف الحالة لغرض
                  معالجتها ومتابعتها برقم مرجعي، ونحتفظ بسجل الشكوى كسجل جودة
                  للفترة اللازمة نظامياً وتشغيلياً. التقييم السريع يمكن تقديمه
                  مجهولاً تماماً — لا نخزن اسمك أو بريدك إلا إذا أذنت صراحةً
                  بالتواصل معك بشأنه.
                </p>
                <p>
                  <strong className="text-snow">المتقدمون للوظائف:</strong>{' '}
                  نعالج بيانات طلب التوظيف (البيانات الأساسية، الإجابات على أسئلة
                  التقييم، السيرة الذاتية، وروابط الأعمال) لغرض إدارة طلبك وتقييم
                  ملاءمتك والتواصل بشأن إجراءات الاختيار فقط. تُحفظ السير الذاتية
                  في مخزن خاص لا روابط عامة له ويقتصر الاطلاع عليها على فريق
                  التوظيف. لا نطلب في نموذج التقديم بيانات عن العمر أو الجنس أو
                  الحالة الاجتماعية أو صوراً شخصية، وسؤال الترتيبات التيسيرية لا
                  يدخل في أي تقييم.
                </p>
                <p>
                  <strong className="text-snow">شبكة المواهب:</strong>{' '}
                  الاحتفاظ ببياناتك لفرص مستقبلية يتم فقط بموافقة مستقلة اختيارية
                  لمدة اثني عشر شهراً، وبعد انتهائها تُخفى هوية الطلب آلياً. وبدون
                  هذه الموافقة تُحذف بيانات الطلب بعد انتهاء عملية التوظيف المعنية
                  وفق سياسة الاحتفاظ.
                </p>
                <p>
                  <strong className="text-snow">بلاغات الخصوصية:</strong>{' '}
                  البلاغ المصنف كحادثة بيانات شخصية يُعالج بمسار مستقل وبمهل
                  الإشعار النظامية المقررة في لائحة نظام حماية البيانات الشخصية.
                </p>
              </div>
            </article>
