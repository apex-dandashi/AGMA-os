...
export default function TermsClient() {
  ...
  const sections = [
    ...
    {
      id: 'voice-careers',
      title: '17. الشكاوى والتقييم والتوظيف عبر الموقع',
      icon: Users,
      content: [
        'يوفر الموقع نموذج شكاوى رسمياً برقم مرجعي ونموذج تقييم سريع. مهل الاستجابة المعلنة (رد أول خلال يوم عمل وحل مستهدف خلال خمسة أيام عمل) سياسة خدمة داخلية تلتزم AGMA بالسعي لتحقيقها، وليست التزاماً نظامياً مفروضاً، وقد تختلف بحسب تعقيد الحالة.',
        'التقديم على الوظائف أو الانضمام إلى شبكة المواهب لا ينشئ أي التزام بالتوظيف أو بالرد خلال مدة معينة إلا ما تقرره الأنظمة المعمول بها، وتُعالج بيانات المتقدمين وفق إشعار خصوصية المتقدمين المبين في سياسة الخصوصية.',
        'يلتزم مستخدم النماذج العامة بعدم إرسال محتوى مسيء أو مضلل أو منتحل، وبعدم رفع ملفات أو بيانات سرية مملوكة للغير، ولـ AGMA رفض أو إغلاق أي بلاغ يخالف ذلك.'
      ]
    }
  ];
