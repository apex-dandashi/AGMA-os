        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-gray-medium text-lg lg:text-xl leading-relaxed font-medium">
              أكثر الميزانيات تضيع لأن التنفيذ يسبق الرؤية. نحدد الجمهور والتموضع والرسالة والقنوات ومؤشرات الأداء أولاً، ثم يُنفق الريال في مكانه.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-gray-medium text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
              الاستشارة تعني مساراً واضحاً وسط خيارات كثيرة. حدد هدفك، ونرسم لك المسار الرقمي الذي يربط علامتك بالنتيجة.
            </p>
          </div>
